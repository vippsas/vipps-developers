...
Reed more about the transition to one platform [here](https://developer.mobilepay.dk/docs/pos/transition-to-one-platform). Below you can find comparison between the existing MobilePay PoS API and the new [ePayment API](/docs/APIs/epayment-api) replacing MobilePay PoS. 
