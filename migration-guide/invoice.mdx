...
import MT from '/docs/vipps-developers/shared-pages/_mt.mdx'

# Invoice to ePayment

Reed more about the transition to one platform [here](https://developer.mobilepay.dk/docs/invoice/transition-to-one-platform). Below you can find comparison between the existing MobilePay Invoice API and the new [ePayment API](/docs/APIs/epayment-api) replacing MobilePay Invoice. 
