...
See:
[Newsletter information and archive](/docs/vipps-developers/newsletters).

## ePayment API

The new [ePayment API](/docs/APIs/epayment-api)
is designed from scratch, based on everything we have
learned through the [eCom API](/docs/APIs/ecom-api)
...
[ePayment API](/docs/APIs/epayment-api), not the
eCom API.

The
[ePayment API specification](/api/epayment)
has been ready for some time, and now we have also updated the
[API guide, FAQ, etc](/docs/APIs/epayment-api).
...
The [Webhooks API](/docs/APIs/webhooks-api)
...
See: [Webhooks API](/docs/APIs/webhooks-api).

## Recurring API: Look up agreements by charge

The new endpoint
[`GET:/charges/{chargeId}`](/api/recurring)
...
See:
[Retrieve a charge](/docs/APIs/recurring-api/vipps-recurring-api#retrieve-a-charge).
...
See the FAQ:
[Express checkout](/docs/APIs/ecom-api/vipps-ecom-api-faq#express-checkout).
...
[Vipps Checkout](/docs/APIs/checkout-api)
...
See
[How it works for shipping](/docs/APIs/checkout-api/vipps-checkout-how-it-works-shipping)
...
In the [Solutions](/docs/vipps-solutions) section of the documentation,
...
See: [Solutions](/docs/vipps-solutions).

## Report API

The [Report API](/docs/APIs/report-api)
...
See the
[API documentation](/docs/APIs/report-api).
...
[Vipps servers](/docs/vipps-developers/developer-resources/servers).
...
Please create [GitHub issues or pull requests](/docs/github)
