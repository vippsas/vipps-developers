...
[The Order Management API](https://developer.vippsmobilepay.com/docs/APIs/order-management-api)
...
[The Partner API](https://developer.vippsmobilepay.com/docs/APIs/partner-api)
...
More details:
[Can I use Vipps with Klarna Checkout?](../knowledge-base/merchant-questions.md#can-i-use-vipps-with-klarna-checkout)

## eCom API: HTTPS required for all URLs

From October 1, 2022, URL links in the body of
[`POST:/payments`](https://developer.vippsmobilepay.com/api/ecom#tag/eCom-API/operation/initiatePaymentV3UsingPOST)
...
* shippingDetailsPrefix
 ...
 See:
 [URL validation](../knowledge-base/url-validation.md).
...
* [Common errors](../knowledge-base/errors.md)
