...
* [Frequently asked questions](https://developer.vippsmobilepay.com/docs/faqs) - See the answers to [common problems](./faqs/common-problems-faq.md), [common errors](./faqs/common-errors-faq.md) and FAQs relating to [reserve and capture](./faqs/reserve-and-capture-faq.md), [users and payments](./faqs/users-and-payments-faq.md), and more.
