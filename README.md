...
**Please note:** Older versions of the test app using a mobile browser for the landing page will currently not work in the test environment. This is because it will always redirect to the production Vipps app, not the MT test app. If the production Vipps app is not installed, the redirect will open Google Play to download the production Vipps app.
