...
![alt text](picturesSFTP/01_velg_profil.png "Velg profil")

2. Find the small hyperlink text under [+ Ny bruker] to add users for SFTP-access. 

![alt text](picturesSFTP/02_SFTP_tilgang.png "lag tilgang")
...
![alt text](picturesSFTP/03_bruker_opprettet.png "bruker opprettet")
