...
The
[`POST:/ecomm/v2/payments/{orderId}/capture`](/api/ecom#tag/Vipps-eCom-API/operation/capturePaymentUsingPOST)
and
...
* [What is the difference between "Reserve Capture" and "Direct Capture"?](#what-is-the-difference-between-reserve-capture-and-direct-capture)
* [Regular eCommerce payments](/docs/APIs/ecom-api/vipps-ecom-api#regular-ecommerce-payments) for more details.
...
* Use a dynamic QR code for Vipps eCom. The QR code must identical to the
  ...
  Vipps. See:
  [Initiate payment flow: API calls](/docs/APIs/ecom-api/vipps-ecom-api#initiate-payment-flow-api-calls).
...
See: [The Vipps QR API](/docs/APIs/qr-api).
...
See:
[The Vipps deeplink URL](/docs/APIs/ecom-api/vipps-ecom-api#the-vipps-deeplink-url).
...
[merchant redirect](/docs/APIs/qr-api/vipps-qr-api#merchant-redirect-qr-codes)
with possibility to update the target URL for stickers, billboards, TV-commercials, magazine ads, etc.

The API also support a
[one-time payment QR code](/docs/APIs/qr-api/vipps-qr-api#one-time-payment-qr-codes)
...
See: [Regular eCom Payments](/docs/APIs/ecom-api/vipps-ecom-api#regular-ecommerce-payments).
