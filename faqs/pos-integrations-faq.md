...
* [QR API](/docs/APIs/qr-api)
* [Error codes](/docs/APIs/ecom-api/vipps-ecom-api#error-codes)
...
[refund](/api/ecom#tag/Vipps-eCom-API/operation/refundPaymentUsingPOST) request.
...
[refund](/api/ecom#tag/Vipps-eCom-API/operation/refundPaymentUsingPOST)
request.
...
[Order management API](/docs/APIs/order-management-api/vipps-order-management-api).
...
2. The partner integrates the POS with Vipps and completes
   [the integration checklist](/docs/APIs/ecom-api/vipps-ecom-api-checklist).
...
See: [Partner keys](/docs/vipps-partner/partner-keys).
...
[``GET:/ecomm/v2/payments/{orderId}/details``](/docs/APIs/ecom-api/vipps-ecom-api#get-payment-details).
...
See: [Error codes](/docs/APIs/ecom-api/vipps-ecom-api#error-codes).
...
* [The Vipps QR API](/docs/APIs/qr-api)

## How can we mass sign up merchants?

See: [Vipps Partners: How to sign up new merchants](/docs/vipps-partner#how-to-sign-up-new-merchants).
